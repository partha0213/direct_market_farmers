    ...
    <Layout title={"About us - Ecommer app"}>
      <div className="row contactus ">
        ...
        <h3> WE ARE AGRIMART</h3>
          ...
          Harvesthubt represents a visionary endeavor led by a group of third-year engineering undergraduates. Its primary mission is to revolutionize the agricultural sector by harnessing the power of cutting-edge technology. This initiative is driven by a steadfast commitment to narrowing the divide between farmers and consumers, making it more than just a marketplace – it's a transformative bridge connecting the agricultural ecosystem with modern technological tools.
